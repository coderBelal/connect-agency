      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center mb-8">
          <button
            ...
            className={`px-6 py-3 mx-2 rounded-lg ${selectedCategory === 'frontend' ? 'bg-blue-500 text-white' : 'bg-white text-blue-500'}`}
          >
            Front-end
          </button>
          <button
            onClick={() => handleCategoryChange('backend')}
            className={`px-6 py-3 mx-2 rounded-lg ${selectedCategory === 'backend' ? 'bg-blue-500 text-white' : 'bg-white text-blue-500'}`}
          >
            Back-end
          </button>
        </div>
