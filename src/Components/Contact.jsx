          ...
          <div className="flex flex-col justify-between h-full">
            ...
            <div className="block">
              ...
              <ul className="mb-14 flex flex-col gap-1 w-[400px]">
                <li className="px-2 text-xl font-semibold leading-normal text-white bg-violet-600 p-[4px] rounded-lg">
              ...
              <ul className="mb-14 flex flex-col gap-1 w-[400px]">
                <li className="text-xl font-semibold leading-normal text-white bg-violet-600 p-[4px] rounded-lg px-2">
                  <a href="tell:+8801________00">
                    <i className="fa-sharp fa-regular fa-phone pr-2" />{" "}
                    +8801________00
                  </a>
                </li>
                <li className="text-xl font-semibold leading-normal text-white bg-violet-600 p-[4px] rounded-lg px-2">
